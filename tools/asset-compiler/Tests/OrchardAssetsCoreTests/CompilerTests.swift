...
final class CompilerTests: XCTestCase {
    ...
    func testCompleteIPhoneAndIPadCatalogCoalescesIdenticalLooseIcons() async throws {
        ...
        try fixture.makeApp(plist: [
            "CFBundleIdentifier": "dev.orchard.full-icons",
            "CFBundleVersion": "42",
            "Unrelated": ["preserved": true],
        ])
        ...
        XCTAssertEqual(plist["CFBundleIdentifier"] as? String, "dev.orchard.full-icons")
    ...
    func testRejectsNestedCatalogSymlinkAndTraversalBeforeMutation() async throws {
        for attack in ["symlink", "traversal"] {
            ...
            defer { fixture.cleanup() }
            try fixture.makeValidCatalog()
            try fixture.makeApp(plist: ["CFBundleIdentifier": "dev.orchard.boundary", "Sentinel": attack])
            let original = try Data(contentsOf: fixture.app.appendingPathComponent("Info.plist"))
    ...
    func testRejectsConflictingDuplicateLooseIconBytesBeforeMutation() async throws {
        ...
        try fixture.makeApp(plist: ["CFBundleIdentifier": "dev.orchard.conflict", "Sentinel": "original"])
        let original = try Data(contentsOf: fixture.app.appendingPathComponent("Info.plist"))
        do {
            _ = try await OrchardAssetCompiler.compile(CompileOptions(catalogPath: fixture.catalog.path, appPath: fixture.app.path))
            XCTFail("compile unexpectedly succeeded")
    ...
    func testRejectsDanglingSignedMarkerAndOutputSymlink() async throws {
        for path in ["_CodeSignature", "Assets.car"] {
            ...
            defer { fixture.cleanup() }
            try fixture.makeValidCatalog()
            try fixture.makeApp(plist: ["CFBundleIdentifier": "dev.orchard.dangling", "Sentinel": path])
            let original = try Data(contentsOf: fixture.app.appendingPathComponent("Info.plist"))
            try FileManager.default.createSymbolicLink(
    ...
    func testRollbackFailureRetainsRecoveryBackupAndReportsDirectory() throws {
        ...
        ).filter { $0.lastPathComponent.hasPrefix(".orchard-assets-stage-") }
...
private struct Fixture {
    ...
    init() throws {
        root = FileManager.default.temporaryDirectory.appendingPathComponent("Orchard Assets Tests & 100%-\(UUID().uuidString)", isDirectory: true)
    ...
    func hasTransactionStage() throws -> Bool {
        try FileManager.default.contentsOfDirectory(at: root, includingPropertiesForKeys: nil)
            .contains { $0.lastPathComponent.hasPrefix(".orchard-assets-stage-") }
    }
}
