...
func (s *Service) State(ctx context.Context) (State, error) {
	...
	capabilities := []Capability{
		...
		capabilityFromTools("asset-catalogs", "Asset catalog compiler", toolMap, []string{"swift", "orchard-assets"}, "unverified", "The registered bridge is available; an actual catalog compile is still required."),
