...
func openDirectoryWithin(string, string) (*os.File, error) {
	return nil, errors.New("secure project directory access is supported only on Linux")
}

func walkRegularFilesInProject(context.Context, string, string, map[string]bool, func(string, *os.File) error) error {
