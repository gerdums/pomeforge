...
func TestCapturedToolVersionClassification(t *testing.T) {
	tests := []struct {
		...
		{"asc-captured-bare-5", "asc", "5.0.0 (commit: 500a36b, date: 2026-09-06T20:09:08+07:00)", "available", "verified by executing"},
		{"asc-bare-5", "asc", "5.2.1", "available", "verified by executing"},
		{"asc-prefixed-5", "asc", "asc version 5.0.0 (commit synthetic)", "available", "verified by executing"},
		{"asc-bare-15", "asc", "15.0.0", "incompatible", "verified ASC 5.x"},
		{"asc-bare-50", "asc", "50.0.0", "incompatible", "verified ASC 5.x"},
		{"asc-bare-4", "asc", "4.2.0", "incompatible", "verified ASC 5.x"},
		{"asc-incidental-5", "asc", "tool output includes 5.0.0", "incompatible", "verified ASC 5.x"},
		{"asc-non-version", "asc", "unknown version", "incompatible", "verified ASC 5.x"},
		{"asc-bare-malformed-suffix", "asc", "5.0.0beta", "incompatible", "verified ASC 5.x"},
		{"asc-prefixed-malformed-suffix", "asc", "asc version 5.0.0beta", "incompatible", "verified ASC 5.x"},
